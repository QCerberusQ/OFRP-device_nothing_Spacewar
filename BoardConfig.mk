...
TARGET_RECOVERY_DEVICE_MODULES := goodix_fp.ko adsp_loader_dlkm.ko msm_drm.ko q6_notifier_dlkm.ko q6_pdr_dlkm.ko sensors_ssc.ko qti_battery_charger_main.ko fts_tp.ko cqhci-crypto-qti.ko cqhci-crypto.ko crypto-qti-common.ko ufs-qcom.ko ufshcd-crypto-qti.ko

# 3. Recovery açılınca hangi modül "insmod" ile yüklensin?
TW_LOAD_VENDOR_MODULES := "goodix_fp.ko adsp_loader_dlkm.ko msm_drm.ko q6_notifier_dlkm.ko q6_pdr_dlkm.ko sensors_ssc.ko qti_battery_charger_main.ko fts_tp.ko cqhci-crypto-qti.ko cqhci-crypto.ko crypto-qti-common.ko ufs-qcom.ko ufshcd-crypto-qti.ko"
